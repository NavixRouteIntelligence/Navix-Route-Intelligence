...
- **Plano (ADR-0093):** reotimização dinâmica, alertas preditivos e CX avançado usam a mesma matriz por tenant. O endpoint manual devolve `403 FORBIDDEN` fora dos planos habilitados; gatilhos de background encerram antes de consultar dados ou enfileirar trabalho.
