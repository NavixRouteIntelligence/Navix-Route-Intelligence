...
void main() {
  ...
  const sample =
      LocationSample(latitude: -23.55, longitude: -46.63, speedKmh: 42);
  ...
  LocationSharingCubit build() => LocationSharingCubit(location, tracking,
  ...
  test('start: obtém posição, envia e passa a compartilhar', () async {
    ...
    verify(() => tracking.sendPosition(any(), status: any(named: 'status')))
        .called(1);
