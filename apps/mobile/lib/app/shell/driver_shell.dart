...
class DriverShell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final menu = [
      NavMenuEntry(
          icon: Icons.navigation_outlined, label: l10n.navRoute, tabIndex: 0),
      NavMenuEntry(
          icon: Icons.inventory_2_outlined,
          label: l10n.navDeliveries,
          tabIndex: 1),
      ...
      NavMenuEntry(
          icon: Icons.build_outlined, label: l10n.navMaintenance, tabIndex: 2),
      NavMenuEntry(
          ...
          onTap: () => _push(
              context,
              ComingSoonPage(
                  title: l10n.navStatistics, icon: Icons.insights_outlined))),
      NavMenuEntry(
