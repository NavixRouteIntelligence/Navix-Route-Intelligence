  ...
  Widget build(BuildContext context) {
    ...
    final menu = [
      ...
      NavMenuEntry(
          ...
          tabIndex: 2),
      NavMenuEntry(
          icon: Icons.podcasts_outlined, label: l10n.navTracking, tabIndex: 3),
      ...
      NavMenuEntry(
          ...
          onTap: () => _push(
              context,
              ComingSoonPage(
                  title: l10n.navSettings, icon: Icons.settings_outlined))),
      const NavMenuEntry.divider(),
      NavMenuEntry(
          icon: Icons.logout,
          label: l10n.signOut,
          danger: true,
          onTap: () => GetIt.instance<SessionCubit>().logout()),
    ];
