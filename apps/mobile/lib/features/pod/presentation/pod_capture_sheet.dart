...
Future<bool?> showPodCaptureSheet(
        ...
        child: DraggableScrollableSheet(
          ...
          builder: (context, scrollController) => ListView(
            ...
            children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 12.5,
                              color: s.gps == GpsStatus.done ? null : t.muted,
                            ),
                          ),
                        ),
                      ],
              ...
              // Foto
              Text(
                'Foto${_needsProof ? ' (foto ou assinatura)' : ''}',
              ...
              if (_needsProof && !_hasProof) ...[
                const SizedBox(height: 8),
                Text(
                  'Adicione foto ou assinatura para confirmar a entrega.',
