...
class _UploadStep extends StatelessWidget {
  ...
  Future<void> _pick(BuildContext context) async {
    ...
    if (path == null) return;
    if (context.mounted) {
      await context.read<ImportCubit>().pickAndPreview(
            path: path,
            filename: file!.name,
          );
    }
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
              ...
              child: Column(
                children: [
                  if (state.busy) ...[
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'Importe suas entregas de uma planilha ou PDF',
        ...
        Text(
          'Até 5 MB · 1000 linhas por arquivo.',
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          const Text(
                            'A rota é preparada automaticamente',
                            style: TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w600,
                            ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 2),
                Text(
                  row.addressText.isEmpty ? '—' : row.addressText,
                  maxLines: 2,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(color: t.muted, fontSize: 12),
                ),
                if (row.errors.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 3),
                  Text(
                    'Baixa confiança (extraído de PDF)',
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Center(
          child: Text(
            '${c?.createdDeliveries ?? 0} entrega(s) criada(s).',
