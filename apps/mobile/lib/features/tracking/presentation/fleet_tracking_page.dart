  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        SafeArea(
          bottom: false,
          child: _TopBar(snap: snap, live: state.live),
        ),
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                bottom: 120,
                child: Text(
                  'Mapa ilustrativo · posições reais',
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: Text(
                'Motoristas (${snap.drivers.length})',
                style: const TextStyle(
                  fontSize: 16,
    ...
    return ListView(
      ...
      children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    driver.plate ?? 'Veículo não informado',
        ...
        if (state.historyLoading)
          ...
          Text(
            'Sem histórico de posições recente.',
