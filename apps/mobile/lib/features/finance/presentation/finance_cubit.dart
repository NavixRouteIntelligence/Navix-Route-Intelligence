...
class FinanceState extends Equatable {
  ...
  List<Object?> get props =>
      [status, summary, entries, insights, history, busy, error];
}
...
class FinanceCubit extends Cubit<FinanceState> {
  ...
  Future<void> load() async {
    ...
    try {
      ...
      emit(const FinanceState(
          status: FinanceStatus.error, error: UnknownFailure()));
    }
  }
  ...
  Future<void> loadSummary() async {
    try {
      ...
      emit(state.copyWith(
          status: FinanceStatus.error, error: const UnknownFailure()));
    }
  }
