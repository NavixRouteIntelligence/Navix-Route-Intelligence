...
class IntelligenceRepository {
  ...
  Future<StopIntelligence> loadForStop({
    ...
    try {
      final forecast = await _dio.post<dynamic>(
        '/intelligence/route-forecast',
        data: {
          'stops': [
      ...
      final insight = await _dio.get<dynamic>(
  ...
  Future<VoiceCommand> interpretVoice(
    String transcript, {
    String? locale,
  }) async {
    try {
      final res = await _dio.post<dynamic>(
        '/intelligence/voice-command',
        data: {'transcript': transcript, if (locale != null) 'locale': locale},
      );
