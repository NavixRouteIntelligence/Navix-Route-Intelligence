...
class StopIntelligenceState extends Equatable {
  const StopIntelligenceState(
      {this.status = StopIntelligenceStatus.idle, this.data, this.error});
...
class StopIntelligenceCubit extends Cubit<StopIntelligenceState> {
  StopIntelligenceCubit(this._repository)
      : super(const StopIntelligenceState());
  ...
  Future<void> load({
    ...
    try {
      ...
      emit(StopIntelligenceState(
          status: StopIntelligenceStatus.success, data: data));
    } on Failure catch (f) {
      emit(StopIntelligenceState(
          status: StopIntelligenceStatus.error, error: f));
    } catch (_) {
      emit(const StopIntelligenceState(
          status: StopIntelligenceStatus.error, error: UnknownFailure()));
    }
  }
}
