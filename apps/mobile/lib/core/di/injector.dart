...
Future<void> configureDependencies(AppConfig config) async {
  getIt
    ...
    ..registerSingleton<AuthRepository>(
      AuthRepositoryImpl(
          api: getIt<AuthApi>(), store: getIt<SecureSessionStore>()),
    )
    ...
    ..registerLazySingleton<LocationSharingCubit>(
      () => LocationSharingCubit(
          getIt<LocationService>(), getIt<TrackingRepository>()),
    )
    ...
    ..registerFactory<PodCaptureCubit>(
      () => PodCaptureCubit(getIt<PodRepository>(), getIt<LocationService>(),
          getIt<TrackingRepository>(), getIt<PodQueueStore>()),
    )
    ..registerSingleton<PodSyncCubit>(
      PodSyncCubit(getIt<PodRepository>(), getIt<PodQueueStore>(),
    ...
    ..registerFactory<VoiceAssistantCubit>(
      () => VoiceAssistantCubit(
          getIt<SpeechService>(), getIt<IntelligenceRepository>()),
    );
}
